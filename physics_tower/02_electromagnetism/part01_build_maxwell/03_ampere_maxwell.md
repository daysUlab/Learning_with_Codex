...
> 章内位置：5〜6 / 15「電流・磁場とAmpère則 → 変位電流とMaxwell方程式」
> 本文前半は真空中の式です。物質中では
>
> $$
> \nabla\times\mathbf{H}
...
と変化するとき、極板全体を貫く変位電流を求めよ。

6. 真空中の式と物質中の式で、対応する場と源を整理せよ。
...
$$
I_{\mathrm{disp}}=\varepsilon_0A\frac{dE}{dt}
$$
...
- 次：[境界条件](../part02_use_maxwell/01_boundary_conditions.md)
