...
は同位相です。これは任意の媒質へ無条件に拡張できません。損失媒質では複素波数と複素物質定数により位相差が生じます。
...
線形・等方・一様で損失がなく、分散を無視できる媒質では

$$
v=\frac{1}{\sqrt{\mu\varepsilon}}
$$

です。一般の物質では物質定数が周波数に依存し、位相速度と群速度も区別します。
...
6. 損失なし媒質の波速を、線形・等方・一様という条件つきで書け。
...
- 次：[Poyntingベクトル](03_poynting_vector.md)
- 親：[Maxwell方程式を使う](README.md)
- 補習：[ODE・PDE](../remedial/02_ode_pde_refresh.md)
