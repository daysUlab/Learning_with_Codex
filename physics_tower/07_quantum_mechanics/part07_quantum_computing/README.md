...
2. [entanglementを使う回路・algorithm](02_entanglement_bell_algorithms.md)
...
Bell・CHSHの正本は[歴史編](../part01_mysteries/04_bell_chsh_experiments.md)です。本partは理想unitary回路だけで完結せず、initialization、control、noise channel、POVM readout、error correction、hardwareを一つの実験systemとして扱います。
