...
## 7. 演習問題
### 問1
次のうち論理式であるものを選びなさい：$P\land Q$、$\to P$、$\lnot(P\lor Q)$。

### 問2
$(P\to Q)\land R$ の主結合子を答えなさい。

### 問3
$P=\mathrm{真}$、$Q=\mathrm{偽}$ のとき、$\lnot P\lor Q$ を評価しなさい。

### 問4
$P\to(Q\land R)$ を構文木の内側から作る順序を説明しなさい。

### 問5
$P\lor\lnot P$ は充足可能なだけですか、それとも妥当ですか。

### 問6
構文エラーと意味評価の誤りをそれぞれ1例挙げなさい。

---

## 8. 演習問題の解答
### 解答1
$P\land Q$ と $\lnot(P\lor Q)$ です。$\to P$ は前件を欠きます。

### 解答2
$\land$ です。式全体は $(P\to Q)$ と $R$ の連言です。

### 解答3
偽です。$\lnot P$ も $Q$ も偽です。

### 解答4
まず $Q$ と $R$ から $(Q\land R)$ を作り、次に $P$ と組み合わせて含意を作ります。

### 解答5
妥当です。$P$ のどの割当でも式全体が真になります。

### 解答6
構文エラーは $P\land$ のような引数不足、意味評価の誤りは $P\to Q$ を常に $P$ と $Q$ の同値だと思うことなどです。
