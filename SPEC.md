...
- `physics_tower/02_electromagnetism` では、`part01_build_maxwell` / `part02_use_maxwell` / `part03_phenomenology` / `qa` / `remedial` の**各サブフォルダで子mdを3件以上**維持し、不足時は本文化前にスケルトンを補完する。
